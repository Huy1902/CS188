...
- [Machine Learning](#machine-learning)
  ...
  - [9. Multi-Class Logistic Regression](#9-multi-class-logistic-regression)

- [Neural Networks](#neural-networks)
  - [1. Multi-Layer Perceptron](#1-multi-layer-perceptron)
  - [2. Measuring Accuracy](#2-measuring-accuracy)
  - [3. Multi-Layer Feedforward Neural Networks](#3-multi-layer-feedforward-neural-networks)
  - [4. Loss Functions and Multivariate Optimization](#4-loss-functions-and-multivariate-optimization)
  - [5. Backpropagation](#5-backpropagation)

- [Reinforcement Learning](#reinforcement-learning)
  - [1. Exploration vs Exploitation](#1-exploration-vs-exploitation)
  - [2. Approaches to RL](#2-approaches-to-rl)
  - [3. Passive vs Active RL](#3-passive-vs-active-rl)
  - [4. Model-Based RL](#4-model-based-rl)
  - [5. Model-Free RL](#5-model-free-rl)

- [Large Language Models (LLM)](#large-language-models-llm)
  - [1. Feature Engineering](#1-feature-engineering)
  - [2. Deep Neural Networks](#2-deep-neural-networks)
  - [3. Multi-Class Classification](#3-multi-class-classification)
  - [4. Unsupervised/Self-Supervised Learning](#4-unsupervisedself-supervised-learning)
  - [5. Reinforcement Learning from Human Feedback](#5-reinforcement-learning-from-human-feedback)
  - [6. Policy Search](#6-policy-search)
  - [7. Beam Search](#7-beam-search)
...
## 1. Terminology:
- Two primary subgroups: supervised learning an unsupervised learning
- Supervised: relationship between input and output
- Unsupervised: relationship  within datapoints
- Training data
- Validation data (hold-out, development data)
- Hyperparameters
- Test set
...
- Linear classifiers:
  ...
  - Decision boundary: in higher dimensions: hyperplane
- Binary perceptron:
  - Updating weight from training set
  - Bias
...
- Turn linear combination of our input features into a probability
...
- Theorem: Universal function approximator: 2 layer - any continuous function(approximate)

## 2. Measuring Accuracy
- Is equivalent to dividing the total number of correct predictions by 
the raw total number of predictions.
- log-likelihood

## 3. Multi-layer Feedforward Neural Networks:
- Sigmoid function
- Rectified linear unit (ReLU)

## 4. Loss functions and Multivariate Optimization:
- Gradient vector
- Bath gradien

## 5. Backpropagation
- Backpropagation represents the neural network as a dependency graph of 
operators and operands, called a computational graph
- The chain rule
- Known operands, forward pass computes output of each node
- Backward pass computes gradients by starting at the final node
- Forward pass + backward pass = backpropagation algorithm
...
- Active: change policy inside training loop
...
- Approximate Q-learning:
  ...
  - Feature vector
  - Q-states as linear value functions
